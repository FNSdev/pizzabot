...
from pizzabot.strategies import ClosestNeighbourStrategy

import pytest


class TestClosestNeighbourStrategy:
    ...
    @pytest.mark.parametrize(
        ...
        [
            (
                ...
                [House(0, 0, '3'), House(0, 0, '2'), House(0, 0, '1')],
            ),
            (
                [
                    House(2, 2, '3'),
    ...
    def _assert_delivery_order(self, houses, expected_delivery_order):
        strategy = ClosestNeighbourStrategy()
